...
BoidRenderer.prototype = {
    ...
    */
    render: function() {
        ...
        this._shaderMaterial.uniforms.uPos.value = this._simulator.currentPositions.texture;
        this._shaderMaterial.uniforms.uVel.value = this._simulator.currentVelocities.texture;
    },
    ...
    _addBoidsToScene(scene) {
        ...
        geometry.setAttribute('boidIndex', new THREE.BufferAttribute(boidIndices,1));
...
//        var edges = new THREE.EdgesHelper(mesh, 0x00ff00);
      ...
      var edgeGeom = new THREE.EdgesGeometry( mesh.geometry ); // or WireframeGeometry
      var edgeMaterial = new THREE.LineBasicMaterial( { color: 0xffff00, linewidth: 2 } );
      var edges = new THREE.LineSegments( edgeGeom, edgeMaterial );
